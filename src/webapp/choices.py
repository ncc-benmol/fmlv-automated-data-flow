...
from ..output.build import _ENUM_FIELDS
...
def field_choices(field: str) -> list[tuple[str, list[tuple[str, str]]]]:
...
def is_valid_choice(field: str, value: str) -> bool:
    ...
    """
    return any(value == option for _group, options in field_choices(field) for option, _ in options)
